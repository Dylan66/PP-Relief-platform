...
import styles from './Footer.module.css'; // New CSS module for the footer
import nairobiMap from '../../assets/images/nairobi_map.png'; // Import the map image
    ...
    <footer className={styles.footer}>
      <div className={styles.footerContent}>
        ...
        <div className={styles.mapContainer}>
          <img src={nairobiMap} alt="Map of Nairobi" className={styles.mapImage} />
        </div>
      </div>
    </footer>
  );
